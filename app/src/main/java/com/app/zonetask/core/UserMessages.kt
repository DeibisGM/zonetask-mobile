...
object UserMessages {
    ...
    object TaskCreate {
        ...
        const val ASSIGNEE_ROTATION_NOTE     = "Manual assignee is ignored while rotation is enabled."
        const val VALIDATION_REQUIRED        = "Please complete the required fields before saving."
        const val ROTATION_SECTION           = "Automatic rotation"
        const val ROTATION_SUBTITLE          = "Share recurring tasks fairly across eligible members."
        const val ROTATION_LABEL             = "Enable automatic rotation"
        const val ROTATION_STRATEGY_LABEL    = "Rotation strategy"
        const val ROTATION_STRATEGY_ROUND_ROBIN = "Round robin"
        const val ROTATION_STRATEGY_RANDOM    = "Random"
        const val ROTATION_STRATEGY_WEIGHTED  = "Weighted by preferences"
        const val ROTATION_HELP              = "Eligible participants are active members of this space. Weighted rotation uses category preferences."
        const val ROTATION_MIN_PARTICIPANTS  = "Automatic rotation requires at least two eligible participants."
